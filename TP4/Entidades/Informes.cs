...
namespace Entidades
{
    public class Informes
    {
        ...
        /// <summary>
        /// Devuelve una Cadena con la Cantidad Total de Dinero que el Gimnasio ha ganado de Cada Tipo
        /// De Membresia.
        /// </summary>
        public string TotalPorTipoDePase()
        {
            ...
            stringBuilder.AppendLine("Total por Pase 'Gympass'  : " + totalPaseGympass * Gimnasio.PrecioGymPass + " $");
            return stringBuilder.ToString();
        }
        #endregion
    }

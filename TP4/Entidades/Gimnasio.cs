...
namespace Entidades
{
    public class Gimnasio
    {
        ...
        public static int PrecioGymPass { get; set; } = 2000;
        public static int PrecioPaseLibre { get; set; } = 3200;
        public static int PrecioMusculacion { get; set; } = 1500;
        #endregion
        ...
        public int TotalFacturado()
        {
            ...
            foreach (Socio socio in this.lista)
            {
                ...
                {
                    total += PrecioPaseLibre;
                }
                else
                {
                    total += PrecioMusculacion;
                }
            }
            return total;
        }
